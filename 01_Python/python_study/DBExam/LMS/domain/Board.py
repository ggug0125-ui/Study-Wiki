class Board:
    ...
    @classmethod
    def from_db(cls, row: dict): # 키,벨류 타입
        ...
        return cls(
            ...
            # active=bool(row.get('active')), db자료에 미구현 나중에 DB에서 알트써서 추가하기
